...
Run: `conda run -n agent4api pytest backend/tests/test_embed_migration.py backend/tests/test_embed_models.py -q`
...
Run: `conda run -n agent4api pytest backend/tests/test_embed_migration.py backend/tests/test_embed_models.py backend/tests/test_final_migration_acceptance.py -q`
...
Run: `conda run -n agent4api pytest backend/tests/test_embed_urls.py -q`
...
Run: `conda run -n agent4api pytest backend/tests/test_admin_settings.py backend/tests/test_admin_embeds.py -q`
...
Run: `conda run -n agent4api pytest backend/tests/test_admin_settings.py backend/tests/test_admin_embeds.py backend/tests/test_admin_write_concurrency.py -q`
...
Run: `conda run -n agent4api pytest backend/tests/test_embed_public.py backend/tests/test_embed_sessions.py -q`
...
Run: `conda run -n agent4api pytest backend/tests/test_embed_public.py backend/tests/test_embed_sessions.py backend/tests/test_spa.py -q`
...
Run: `conda run -n agent4api ruff check backend`

Expected: PASS.

- [ ] **Step 2: Run the complete backend suite**

Run: `conda run -n agent4api pytest backend/tests -q`
