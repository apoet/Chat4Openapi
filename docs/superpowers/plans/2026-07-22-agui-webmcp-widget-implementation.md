...
Run: `conda run -n chatapi pytest backend/tests/test_agui_contracts.py backend/tests/test_agui_events.py -q`
...
Run: `conda run -n chatapi pytest backend/tests/test_agui_runtime.py -q`
...
Run: `conda run -n chatapi pytest backend/tests/test_agui_runtime.py backend/tests/test_agent_runtime.py backend/tests/test_chat_turn_api.py -q`
...
Run: `conda run -n chatapi pytest backend/tests/test_embed_agent_api.py -q`
...
Run: `conda run -n chatapi pytest backend/tests/test_embed_agent_api.py backend/tests/test_embed_sessions.py backend/tests/test_agent_runtime.py -q`
