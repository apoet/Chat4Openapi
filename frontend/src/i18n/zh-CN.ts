export default {
  ...
  autoAgentify: {
    eyebrow: '自动编排', title: '生成 Skills 和 Agents', subtitle: '分析 OpenAPI 定义，自动创建最精简、最有业务价值的 Skills 和核心 Agents。', open: 'AI 智能生成', close: '关闭生成器', provider: '分析供应商', selectProvider: '选择已启用的供应商', name: '来源名称', baseUrl: 'Base URL（可选）', urlMode: 'OpenAPI URL', fileMode: 'OpenAPI 文件', url: 'OpenAPI URL', document: 'OpenAPI 文档', generate: '生成 Skills 和 Agents', analyzing: '正在分析…', phase: '正在解析接口、提炼业务能力并创建配置。', resultTitle: '生成完成', counts: '已启用 {tools}/{imported} 个 Tools · {skills} 个 Skills · {agents} 个 Agents', skills: '生成的 Skills', agents: '核心 Agents',
