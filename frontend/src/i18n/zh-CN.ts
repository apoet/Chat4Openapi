export default {
  ...
  users: { nav: '用户', eyebrow: '系统访问', title: '用户管理', subtitle: '管理普通用户，普通用户仅可访问 Build 域功能。', username: '用户名', password: '密码', passwordKeep: '留空则保留当前密码', locale: '界面语言', enabled: '允许登录', create: '创建用户', update: '保存更改', cancel: '取消', edit: '编辑', empty: '暂无普通用户。' },
  agent: {
