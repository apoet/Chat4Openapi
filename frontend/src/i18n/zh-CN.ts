export default {
  ...
  settings: { nav: '系统设置', eyebrow: '系统', title: '系统设置', subtitle: '配置嵌入脚本与 OAuth 回调使用的公开访问地址。', baseUrl: '本系统 Base URL', baseUrlHint: '请填写外部可访问的 HTTPS 地址，末尾斜杠会自动移除。', save: '保存设置', saved: '已保存：' },
  embeds: { eyebrow: '传统站点赋能', title: '嵌入式对话', subtitle: '创建一个或多个绑定当前 Agent 的站点脚本。', name: '配置名称', position: 'Logo 位置', bottomRight: '右下角', bottomLeft: '左下角', origins: '允许的宿主站点来源', originsHint: '每行一个精确 Origin，例如 https://portal.example.com', noOrigins: '尚未配置宿主来源', create: '创建嵌入配置', copy: '复制脚本', copied: '已复制', preview: '预览', edit: '编辑配置', save: '保存配置', loadFailed: '无法加载嵌入配置。' },
