export default {
  ...
  agent: {
    ...
    systemPrompt: '系统提示词', save: '保存 Agent', default: '默认', lifecycle: 'Agent 生命周期',
    ...
    noBoundSkills: '尚未绑定 Skill。', running: '运行中', stopped: '已停止',
    addSkill: '添加 {name}', removeSkill: '移除 {name}', moveUp: '上移 {name}', moveDown: '下移 {name}',
    keys: {
      eyebrow: '客户端访问', title: 'API 密钥', label: '密钥标签', expiry: '密钥到期时间',
      create: '创建 API 密钥', newKey: '新 API 密钥', oneTimeWarning: '请立即复制此密钥，之后将无法再次查看。',
      copy: '复制密钥', copying: '复制中…', close: '完成', closeSecret: '关闭密钥',
  ...
  chat: {
    ...
    emptyHint: '让 Agent 从全部运行中的 Skill 自动选择，或在下方限制候选范围。',
    message: '消息',
    placeholder: '输入问题…',
    ...
    sending: '发送中…',
    skill: 'Skills',
    skillHint: '空选表示允许全部运行中的 Skill',
    scopeLocked: '本会话的候选 Skill 范围已锁定',
    autoSelect: 'Agent 自动选择',
    selectSkills: '选择候选 Skill',
    candidateSkills: '候选 Skill',
    chooseSkills: '选择 Skill',
    removeSkill: '移除 {name}',
    noRunningSkills: '暂无运行中的 Skill',
  ...
  error: {
    ...
    agents: {
      ...
      save_failed: '无法保存 Agent。', action_failed: '无法更新 Agent 状态。',
